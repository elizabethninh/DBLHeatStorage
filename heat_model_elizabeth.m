...
for i = 1:t_final
    ...
    Qdot_loss_hsv(i) = (T_water(i)-T_amb)/R_hsv ;                           %Heat loss hsv. R_hsv No large influence.
    Qdot_loss_pur(i) = (T_water(i)-T_amb)/R_pur;                            %Heat loss polyurethane tubing 
    Qdot_loss_con(i) = (T_water(i)-T_amb)/R_con;                            %Heat loss of the two 10cm long press-fit coupling tube sections sticking out of HSV. R_con Has a really large influence for some reason.
